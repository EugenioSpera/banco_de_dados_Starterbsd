...
/*Default - Se o usuario nao preencher a cidade ele vai complementar sozinho,*/
 
 

SELECT * FROM CLIENTES    (Vai mostrar a tabela cliente criada, lembrando que para selecionar e criar a tabela so apertar o ctrl + f9
)
